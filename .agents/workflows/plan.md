...
Mở và đọc file skill brainstorming tại đường dẫn sau:
...
3. Viết code theo đúng conventions của project (xem các file trong .agents/rule/).
